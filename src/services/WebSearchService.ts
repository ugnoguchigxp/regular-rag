...
import type { WebSearchOptions, WebSearchProvider, WebSearchResult } from "../providers/types";
...
export class WebSearchService {
    ...
    constructor(provider: WebSearchProvider, options: WebSearchServiceOptions = {}) {
